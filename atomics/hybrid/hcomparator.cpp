...
void hcomparator::init(double t,...) {
...
double hcomparator::ta(double t) {
//This function returns a double.
return sigma;
}
void hcomparator::dint(double t) {
if (sigma==0) {
sigma=tcross;
} else {
	for (int i=0;i<2;i++) {
...
void hcomparator::dext(Event x, double t) {
...
Event hcomparator::lambda(double t) {
