#include "hsaturation.h"
void hsaturation::init(double t,...) {
...
double hsaturation::ta(double t) {
//This function returns a double.
return sigma;
}
void hsaturation::dint(double t) {
if(sigma!=0){
...
void hsaturation::dext(Event x, double t) {
u1=u+mu*e+pu*e*e;
double *xv;
xv=(double*)(x.value);
u=xv[0];
...
Event hsaturation::lambda(double t) {
