...
outval = va_arg(parameters,double);
inf=1e10;
u=0;
mu=0;
pu=0;
...
double crossdetect::ta(double t) {
//This function returns a double.
return sigma;
}
void crossdetect::dint(double t) {
if (sigma==0) {
   sigma=tcross;
} else {
...
void crossdetect::dext(Event x, double t) {
...
Event crossdetect::lambda(double t) {
