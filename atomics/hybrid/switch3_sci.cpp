#include "switch3_sci.h"
void switch3_sci::init(double t,...) {
...
double switch3_sci::ta(double t) {
//This function returns a double.
return sigma;
}
void switch3_sci::dint(double t) {
if (sigma==0) {
   sigma=tcross;
} else {
  for (int i=0;i<3;i++) {
...
void switch3_sci::dext(Event x, double t) {
...
Event switch3_sci::lambda(double t) {
