...
double switching::ta(double t) {
//This function return a double.
return sigma;
}
void switching::dint(double t) {
sigma=inf;
}
void switching::dext(Event x, double t) {
...
Event switching::lambda(double t) {
