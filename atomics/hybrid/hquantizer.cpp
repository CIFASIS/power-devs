...
double hquantizer::ta(double t) {
//This function returns a double.
return sigma;
}
void hquantizer::dint(double t) {
if(sigma==0){
...
void hquantizer::dext(Event x, double t) {
...
Event hquantizer::lambda(double t) {
