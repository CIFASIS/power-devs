#include "qss_multiplier_vec.h"
void qss_multiplier_vec::init(double t,...) {
...
for (int i=0;i<N;i++){ 
	sprintf(childi,"qss_sum%i",i);
	D1[i] = new qss_multiplier(childi);
	D1[i]->init(t,"Estimate step",0.0,0.0);
}	
...
double qss_multiplier_vec::ta(double t) {
//This function returns a double.
return D0->ta(t);
}
void qss_multiplier_vec::dint(double t) {
D0->dint(t);
}
void qss_multiplier_vec::dext(Event x, double t) {
...
Event qss_multiplier_vec::lambda(double t) {
