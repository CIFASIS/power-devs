...
double nlfunction::ta(double t) {
return sigma;
}
void nlfunction::dint(double t) {
sigma=inf;
}
void nlfunction::dext(Event x, double t) {
...
Event nlfunction::lambda(double t) {
y[0]=f;
y[1]=mf;
y[2]=pf;
return Event(&y[0],0);
}
void nlfunction::exit() {
