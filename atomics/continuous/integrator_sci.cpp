#include "integrator_sci.h"
void integrator_sci::init(double t,...) {
...
double integrator_sci::ta(double t) {
//This function return a double.
return sigma;
}
void integrator_sci::dint(double t) {
double s;
switch(met) {
case 1: // QSS
      X=X+sigma*u;
...
void integrator_sci::dext(Event x, double t) {
...
Event integrator_sci::lambda(double t) {
