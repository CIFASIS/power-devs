#include "logintegrator_sci.h"
void logintegrator_sci::init(double t,...) {
...
double logintegrator_sci::ta(double t) {
//This function return a double.
return sigma;
}
void logintegrator_sci::dint(double t) {
switch(met) {
case 1: // QSS
      X=X+sigma*u;
     dQ=fabs(X)*dQrel;
...
void logintegrator_sci::dext(Event x, double t) {
...
Event logintegrator_sci::lambda(double t) {
