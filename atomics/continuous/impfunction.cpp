...
void impfunction::init(double t,...) {
...
double impfunction::ta(double t) {
//This function return a double.
return sigma;
}
void impfunction::dint(double t) {
sigma=INF;
}
void impfunction::dext(Event x, double t) {
...
Event impfunction::lambda(double t) {
