#include "resintegrator.h"
void resintegrator::init(double t,...) {
...
double resintegrator::ta(double t) {
//This function return a double.
return sigma;
}
void resintegrator::dint(double t) {
...
void resintegrator::dext(Event x, double t) {
...
Event resintegrator::lambda(double t) {
