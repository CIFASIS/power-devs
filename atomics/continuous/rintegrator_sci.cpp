#include "rintegrator_sci.h"
void rintegrator_sci::init(double t,...) {
...
double rintegrator_sci::ta(double t) {
//This function return a double.
return sigma;
}
void rintegrator_sci::dint(double t) {
if (strcmp(Method,"QSS")==0) {
  X=X+sigma*u;
  q=X;
  if (u==0) {
...
void rintegrator_sci::dext(Event x, double t) {
...
Event rintegrator_sci::lambda(double t) {
